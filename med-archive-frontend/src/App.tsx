...
function App() {
  ...
  const isDashPatientRoute = currentPath.startsWith("/espacepatient") || currentPath.startsWith("/DasbordPatient") ||
    currentPath.startsWith("/espacemedecin") || currentPath.startsWith("/espaceaccueil") || currentPath.startsWith("/espaceexamen") || currentPath.startsWith("/espacehopital") || currentPath.startsWith("/connexion") || currentPath.startsWith("/deconnexion");;
